...
namespace PokemonGame.PokemonBattle.Data.Pokemons
{
	public class Slowbro : Pokemon
	{
		...
		{
			[1] = new List<Move>() { new Withdraw(), new Tackle(), new Curse(), new Growl(), new Watergun() },
			...
			[51] = new List<Move>() { new Healpulse() },
		};
		public override List<Move> TutorMoves => new List<Move>() { new Aerialace(), new Amnesia(), new Attract(), new Avalanche(), new Blizzard(), new Bodypress(), new Bodyslam(), new Brickbreak(), new Brine(), new Bulldoze(), new Calmmind(), new Dig(), new Dive(), new Doubleteam(), new Drainpunch(), new Dreameater(), new Earthquake(), new Endure(), new Expandingforce(), new Facade(), new Fireblast(), new Flamethrower(), new Flash(), new Fling(), new Focusblast(), new Focuspunch(), new Foulplay(), new Futuresight(), new Gigaimpact(), new Grassknot(), new Hail(), new Hiddenpower(), new Hydropump(), new Hyperbeam(), new Icebeam(), new Icepunch(), new Icywind(), new Imprison(), new Irondefense(), new Irontail(), new Lightscreen(), new Liquidation(), new Megakick(), new Megapunch(), new Muddywater(), new Mudshot(), new Nastyplot(), new Payday(), new Protect(), new Psychic(), new Psychicterrain(), new Psychup(), new Psyshock(), new Raindance(), new Razorshell(), new Recycle(), new Rest(), new Rocksmash(), new Round(), new Safeguard(), new Scald(), new Shadowball(), new Skillswap(), new Sleeptalk(), new Snore(), new Storedpower(), new Strength(), new Substitute(), new Sunnyday(), new Surf(), new Swagger(), new Swift(), new Thunderwave(), new Triattack(), new Trick(), new Trickroom(), new Waterpulse(), new Weatherball(), new Whirlpool(), new Wonderroom(), new Zenheadbutt() };

...
namespace PokemonGame.PokemonBattle.Data.Pokemons
{
	public class Graveler : Pokemon
	{
		...
		{
			[1] = new List<Move>() { new Tackle(), new Defensecurl(), new Rockpolish() },

...
public class Plusle : Pokemon
{
	...
	public override List<Ability> AvailableAbilities => new() {new Abilities.Plus() };
	...
	public override Dictionary<int, List<Move>> LevelUpLearnSet => new()
	{
		...
		[13] = new List<Move>() { new Moves.Skillswap() },

...
namespace PokemonGame.PokemonBattle.Data.Pokemons
{
	public class Minun : Pokemon
	{
		...
		public override List<Move> TutorMoves => new List<Move>() { new Attract(), new Chargebeam(), new Confide(), new Covet(), new Doubleteam(), new Echoedvoice(), new Electroweb(), new Endure(), new Facade(), new Flash(), new Fling(), new Frustration(), new Grassknot(), new Helpinghand(), new Hiddenpower(), new Irontail(), new Lastresort(), new Lightscreen(), new Magnetrise(), new Nastyplot(), new Protect(), new Raindance(), new Rest(), new Return(), new Round(), new Shockwave(), new Signalbeam(), new Sleeptalk(), new Snore(), new Substitute(), new Swagger(), new Thunder(), new Thunderbolt(), new Thunderpunch(), new Thunderwave(), new Uproar(), new Voltswitch(), new Wildcharge() };

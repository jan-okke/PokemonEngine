...
public class Latios : Pokemon
{
	...
	public override Stats BaseStats => new Stats(80, 90, 80, 130, 110, 110);
	public override ExperienceGroup ExperienceGroup => ExperienceGroup.Slow;
	public override List<PokemonType> Types => new() {PokemonType.Dragon, PokemonType.Psychic };
	public override Dictionary<int, List<Move>> LevelUpLearnSet => new()
	{
		[1] = new List<Move>() { new Moves.Storedpower(), new Moves.Dragondance() },
		...
		[30] = new List<Move>() { new Moves.Allyswitch() },
		[35] = new List<Move>() { new Moves.Lusterpurge() },

...
namespace PokemonGame.PokemonBattle.Data.Pokemons
{
	public class Gurdurr : Pokemon
	{
		...
		public override List<Move> TutorMoves => new List<Move>() { new Attract(), new Brickbreak(), new Brutalswing(), new Bulkup(), new Closecombat(), new Coaching(), new Dig(), new Drainpunch(), new Endure(), new Facade(), new Firepunch(), new Fling(), new Focusblast(), new Focusenergy(), new Grassknot(), new Helpinghand(), new Hiddenpower(), new Highhorsepower(), new Icepunch(), new Lowkick(), new Lowsweep(), new Megakick(), new Megapunch(), new Payback(), new Poisonjab(), new Protect(), new Raindance(), new Rest(), new Retaliate(), new Revenge(), new Reversal(), new Rockslide(), new Rocktomb(), new Round(), new Scaryface(), new Sleeptalk(), new Snore(), new Stoneedge(), new Substitute(), new Sunnyday(), new Superpower(), new Taunt(), new Thunderpunch(), new Workup() };

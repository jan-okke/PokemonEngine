...
namespace PokemonGame.PokemonBattle.Data.Pokemons
{
	public class Machoke : Pokemon
	{
		...
		{
			[1] = new List<Move>() { new Moves.Lowkick(), new Moves.Leer(), new Moves.Focusenergy(), new Moves.Revenge() },

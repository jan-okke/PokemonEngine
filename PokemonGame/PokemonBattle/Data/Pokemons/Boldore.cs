...
namespace PokemonGame.PokemonBattle.Data.Pokemons
{
	public class Boldore : Pokemon
	{
		...
		public override List<Move> TutorMoves => new List<Move>() { new Attract(), new Bodypress(), new Bulldoze(), new Earthpower(), new Earthquake(), new Endure(), new Facade(), new Flashcannon(), new Heavyslam(), new Hiddenpower(), new Irondefense(), new Meteorbeam(), new Powergem(), new Protect(), new Rest(), new Rockblast(), new Rockslide(), new Rocktomb(), new Round(), new Sandstorm(), new Sandtomb(), new Sleeptalk(), new Snore(), new Stealthrock(), new Stompingtantrum(), new Stoneedge(), new Substitute() };

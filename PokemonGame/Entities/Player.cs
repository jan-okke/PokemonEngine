...
namespace PokemonGame.Entities
{
    public class Player
    {
        ...
        { 
            get => new Point((DisplayX - 64 + Settings.DisplayWidth / 2) / 32, (DisplayY - 48 + Settings.DisplayHeight / 2) / 32);
            set { DisplayX = 64 + value.X * 32 - Settings.DisplayWidth / 2; DisplayY = 48 + value.Y * 32 - Settings.DisplayHeight / 2; }
        }
